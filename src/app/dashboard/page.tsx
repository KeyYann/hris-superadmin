...
export default function DashboardPage() {
  const { notifications, unreadCount, timeOffRequests, pendingTimeOffCount, users, calendarEvents } = useNotifications();
  ...
  // --- DERIVED STATS ---
  // Filter out Super Admin and Admin users from the count (show only regular employees)
  const regularUsersCount = users.filter(u => u.role !== 'Super Admin' && u.role !== 'Admin').length;
