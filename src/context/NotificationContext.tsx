...
export interface TimeOffRequest {
  ...
  submitted: string;
  leaveDate: string;
  endDate?: string; // Optional end date for multi-day leaves
  type: string;
  status: string;
  duration: string;
  isHalfDay?: boolean; 
  halfDayPeriod?: 'morning' | 'afternoon'; // Morning (8-12) or Afternoon (1-5)
  message: string;
}
...
const INITIAL_USERS: User[] = [
  ...
  { id: 'u4', name: 'Emily White', role: 'Developer', email: 'emily.w@abbeconsult.com', department: 'Engineering', status: 'Active', avatar: 'EW', employmentStatus: 'Regular Employee' },
  ...
  { id: 'u12', name: 'Patricia Miller', role: 'Developer', email: 'patricia.m@abbe.com', department: 'Engineering', status: 'Active', avatar: 'PM', employmentStatus: 'Regular Employee' },
...
const INITIAL_TIME_OFF_REQUESTS: TimeOffRequest[] = [
  { id: '399', user: 'James Wilson', avatar: 'JW', role: 'QA', submitted: '2026-02-13', leaveDate: '2026-02-18', type: 'Sick Leave', status: 'Pending', duration: '0.5 Days', isHalfDay: true, halfDayPeriod: 'morning', message: 'Doctor appointment in the morning.' },
  { id: '400', user: 'Mike Johnson', avatar: 'MJ', role: 'Developer', submitted: '2026-02-12', leaveDate: '2026-02-20', endDate: '2026-02-24', type: 'Sick Leave', status: 'Pending', duration: '5 Days', isHalfDay: false, message: 'Medical leave.' },
  { id: '401', user: 'Alice Chen', avatar: 'AC', role: 'Admin Managers', submitted: '2026-02-11', leaveDate: '2026-02-25', endDate: '2026-02-28', type: 'Vacation Leave', status: 'Approved', duration: '4 Days', isHalfDay: false, message: 'Family trip.' },
  { id: '402', user: 'Patricia Miller', avatar: 'PM', role: 'Developer', submitted: '2026-02-10', leaveDate: '2026-02-17', type: 'Vacation Leave', status: 'Approved', duration: '0.5 Days', isHalfDay: true, halfDayPeriod: 'afternoon', message: 'Afternoon off for personal matters.' },
  { id: '403', user: 'Christopher Martinez', avatar: 'CM', role: 'Developer', submitted: '2026-02-09', leaveDate: '2026-02-19', endDate: '2026-02-21', type: 'Vacation Leave', status: 'Pending', duration: '3 Days', isHalfDay: false, message: 'Short vacation.' },
  { id: '404', user: 'Jennifer Thomas', avatar: 'JT', role: 'Admin Managers', submitted: '2026-02-08', leaveDate: '2026-02-22', type: 'Sick Leave', status: 'Approved', duration: '0.5 Days', isHalfDay: true, halfDayPeriod: 'morning', message: 'Medical checkup.' },
  { id: '365', user: 'Roger Jr. Dumaguit', avatar: 'RD', role: 'Developer', submitted: '2026-02-07', leaveDate: '2026-02-16', type: 'Vacation Leave', status: 'Approved', duration: '0.5 Days', isHalfDay: true, halfDayPeriod: 'morning', message: 'Morning off for personal errand.' },
  { id: '366', user: 'Jomel Dela Cruz', avatar: 'JD', role: 'Designer', submitted: '2026-02-06', leaveDate: '2026-02-14', endDate: '2026-02-15', type: 'Sick Leave', status: 'Pending', duration: '2 Days', isHalfDay: false, message: 'Not feeling well.' },
  { id: '367', user: 'David Brown', avatar: 'DB', role: 'QA', submitted: '2026-02-05', leaveDate: '2026-02-23', type: 'Emergency Leave', status: 'Declined', duration: '1 Day', isHalfDay: false, message: 'Personal matter.' },
  { id: '369', user: 'Emily White', avatar: 'EW', role: 'Developer', submitted: '2026-02-04', leaveDate: '2026-02-26', endDate: '2026-03-07', type: 'Sick Leave', status: 'Approved', duration: '10 Days', isHalfDay: false, message: 'Migraine recovery.' },
  { id: '370', user: 'Laurence Rey', avatar: 'LR', role: 'Designer', submitted: '2026-02-03', leaveDate: '2026-02-27', endDate: '2026-02-28', type: 'Vacation Leave', status: 'Pending', duration: '2 Days', isHalfDay: false, message: 'Attending a conference.' },
  { id: '371', user: 'Rommel Manalo', avatar: 'RM', role: 'Developer', submitted: '2026-02-02', leaveDate: '2026-03-01', type: 'Vacation Leave', status: 'Approved', duration: '0.5 Days', isHalfDay: true, halfDayPeriod: 'afternoon', message: 'Personal errand in the afternoon.' },
  { id: '372', user: 'Maria Garcia', avatar: 'MG', role: 'Designer', submitted: '2026-02-01', leaveDate: '2026-03-05', endDate: '2026-03-12', type: 'Vacation Leave', status: 'Approved', duration: '8 Days', isHalfDay: false, message: 'Vacation abroad.' },
  { id: '373', user: 'Robert Taylor', avatar: 'RT', role: 'Developer', submitted: '2026-01-30', leaveDate: '2026-02-15', type: 'Sick Leave', status: 'Approved', duration: '1 Day', isHalfDay: false, message: 'Flu symptoms.' },
  { id: '374', user: 'Michael Anderson', avatar: 'MA', role: 'Developer', submitted: '2026-01-28', leaveDate: '2026-03-10', endDate: '2026-03-14', type: 'Vacation Leave', status: 'Pending', duration: '5 Days', isHalfDay: false, message: 'Spring break.' },
];
...
const INITIAL_NOTIFICATIONS = [
  ...
  { id: 2, type: 'leave', user: 'Roger Jr. Dumaguit', action: 'submitted a', target: 'Sick Leave', time: '5 hours ago', timestamp: new Date(Date.now() - 18000000), isRead: false, avatarColor: 'bg-purple-100 text-purple-600', initials: 'RD' },
  { id: 3, type: 'overtime', user: 'Mike Johnson', action: 'submitted an', target: 'Overtime Request', time: '8 hours ago', timestamp: new Date(Date.now() - 28800000), isRead: false, avatarColor: 'bg-orange-100 text-orange-600', initials: 'MJ' },
  { id: 4, type: 'official-business', user: 'David Brown', action: 'submitted an', target: 'Official Business Request', time: 'Yesterday', timestamp: new Date(Date.now() - 86400000), isRead: false, avatarColor: 'bg-green-100 text-green-600', initials: 'DB' },
  { id: 5, type: 'leave', user: 'Laurence Rey', action: 'submitted a', target: 'Sick Leave', time: 'Yesterday', timestamp: new Date(Date.now() - 90000000), isRead: true, avatarColor: 'bg-purple-100 text-purple-600', initials: 'LR' },
  { id: 6, type: 'overtime', user: 'Emily White', action: 'updated their', target: 'Overtime Request', time: '2 days ago', timestamp: new Date(Date.now() - 172800000), isRead: true, avatarColor: 'bg-orange-100 text-orange-600', initials: 'EW' },
  { id: 7, type: 'leave', user: 'Alice Chen', action: 'submitted a', target: 'Emergency Leave', time: '3 days ago', timestamp: new Date(Date.now() - 259200000), isRead: true, avatarColor: 'bg-red-100 text-red-600', initials: 'AC' },
  { id: 8, type: 'official-business', user: 'Rommel Manalo', action: 'submitted an', target: 'Official Business Request', time: '4 days ago', timestamp: new Date(Date.now() - 345600000), isRead: true, avatarColor: 'bg-teal-100 text-teal-600', initials: 'RM' },
  { id: 9, type: 'leave', user: 'James Wilson', action: 'cancelled their', target: 'Vacation Leave', time: '5 days ago', timestamp: new Date(Date.now() - 432000000), isRead: true, avatarColor: 'bg-gray-100 text-gray-600', initials: 'JW' },
  { id: 10, type: 'overtime', user: 'Patricia Miller', action: 'submitted an', target: 'Overtime Request', time: '6 days ago', timestamp: new Date(Date.now() - 518400000), isRead: true, avatarColor: 'bg-orange-100 text-orange-600', initials: 'PM' },
  { id: 11, type: 'leave', user: 'Christopher Martinez', action: 'submitted a', target: 'Sick Leave', time: '1 week ago', timestamp: new Date(Date.now() - 604800000), isRead: true, avatarColor: 'bg-purple-100 text-purple-600', initials: 'CM' },
  { id: 12, type: 'official-business', user: 'Jennifer Thomas', action: 'submitted an', target: 'Official Business Request', time: '1 week ago', timestamp: new Date(Date.now() - 608400000), isRead: true, avatarColor: 'bg-green-100 text-green-600', initials: 'JT' },
];
